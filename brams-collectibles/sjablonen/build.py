#!/usr/bin/env python3
"""Brams Collectibles sjablonen — op de maatvoering van het eigen
advertentiesjabloon (810x1013 pt), inclusief het gouden plateau.
Logo en teksten zijn de echte bestanden."""
import csv, json, pathlib

F = json.load(open('fonts-b64.json'))

# Het register is de bron voor namen, prijzen en hoogtepunten. Staat er geen
# prijs in, dan blijft [PRIJS] staan zodat je het meteen ziet.
